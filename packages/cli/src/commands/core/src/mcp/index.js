 ...
 */
import { buildPrompt, injectPrompt, BLOCK_TYPES, MODES } from '../index.js';
/**
 * In-memory prompt storage implementation
 */
export class MemoryPromptStorage {
    prompts = new Map();
 ...
 */
export class FilePromptStorage {
    basePath;
...
export class PromptOrDieMCPServer {
     ...
     */
    createPromptBlock(type, label, value) {
        return {
            id: this.generateId(),
            type,
            label,
 ...
 */
export function createMCPServer(config, storage) {
